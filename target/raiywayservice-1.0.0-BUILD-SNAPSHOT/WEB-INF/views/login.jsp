...
<body>
				<div class="login-form">
					<div class="head">
						<img src="resources/images/mem2.jpg" alt=""/>
 ...
 <div class="p-container">
		...
		<label class="checkbox"><input type="checkbox" name="_spring_security_remember_me"><i></i>Remember Me</label>
		...
		<input type="submit" class="btnLogin" value="login">
		 <a href="<c:url value='/regist'/>" >createUser</a>
